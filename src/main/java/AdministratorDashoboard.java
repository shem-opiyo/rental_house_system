 ...
 * @author shonic
 */
public class AdministratorDashoboard extends javax.swing.JFrame {

    /**
     * Creates new form AdministratorDashoboard
     */
    public AdministratorDashoboard() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel2.setBackground(new java.awt.Color(11, 11, 242));

        jLabel1.setBackground(new java.awt.Color(0, 0, 242));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdministratorDashoboard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdministratorDashoboard().setVisible(true);
            }
        });
    }
